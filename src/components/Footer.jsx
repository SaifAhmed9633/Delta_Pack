    ...
    <footer className="w-full border-t border-white/5 bg-black z-20">
      <div className="max-w-7xl mx-auto px-6 md:px-12 py-10 flex flex-col md:flex-row items-center justify-between gap-6">
        <div className="text-center md:text-left">
          ...
          <p className="text-[10px] font-mono text-gray-600 tracking-widest mt-1">MANUFACTURING EGYPT · EST. 2010</p>
        </div>
        ...
        <p className="text-[10px] font-mono text-gray-700 tracking-widest">© 2026 ALL RIGHTS RESERVED</p>
      </div>
    </footer>
  );
}
